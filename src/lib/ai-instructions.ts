...
function generateTokenInstructions(
  ...
  switch (model) {
    case 'gemini':
      ...
      return `When I mention "${listName}" or ask to add something to it, first confirm by asking "You want me to add [item] to ${listName}. Proceed?" When I confirm, ${actionStepsCompact}.
URL: GET ${url}
Fields:
${fieldDefs}
